## Hi, I'm Soumyadeep 👋
### Full-stack developer · AI engineering student · Kolkata, India

> I enjoy building things end-to-end — from data models to deployed products. Currently going deep on AI engineering: LLMs, RAG, agents, and production infrastructure.

---

### 🔨 Currently
- 📚 Working through a 6-month full-stack AI study plan (LLMs → RAG → agents → MCP → AWS)
- 🚀 Building **SalesInsight** — an AI-powered sales analytics & forecasting platform
- 🎯 Cert targets: `Docker DCA` → `AWS CLF-C02` → `Anthropic Prompt Engineering` → `AWS SAA-C03`
- ⚡ Fun fact: I track my personal investment portfolio with a dashboard I built myself
